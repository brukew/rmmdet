#!/bin/bash
#SBATCH --job-name=stgcnpp_4cls_cv_j
#SBATCH --partition=mit_preemptable
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/4class_cv_j_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/4class_cv_j_%j.err

echo "=========================================="
echo "STGCN++ Training: 4-class 3-Fold CV (Joint)"
...
BASE_WORK_DIR="work_dirs/stgcnpp/cv/4class_conf04_j"
EPOCHS=24
LR=0.01
