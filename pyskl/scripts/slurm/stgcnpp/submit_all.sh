#!/bin/bash
# Submit all STGCN++ 4-stream training jobs for SAILS
# Usage: bash scripts/slurm/stgcnpp/submit_all.sh [--dry-run]
...
echo "=========================================="
echo "STGCN++ SAILS 4-Stream Training"
echo "Date: $(date)"
echo "=========================================="
echo ""
...
SCRIPTS=(
    "pyskl/scripts/slurm/stgcnpp/train_4class_single_4stream.sh"
    "pyskl/scripts/slurm/stgcnpp/train_5class_single_4stream.sh"
...
echo "  - Single split: 4 modalities × 24 epochs ≈ 30-40 min"
echo "  - CV (3-fold):  4 modalities × 3 folds × 24 epochs ≈ 2-3 hours"
echo ""
