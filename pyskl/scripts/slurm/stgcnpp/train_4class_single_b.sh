#!/bin/bash
#SBATCH --job-name=stgcnpp_4cls_b
#SBATCH --partition=mit_preemptable
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=06:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/4class_single_b_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/4class_single_b_%j.err

echo "=========================================="
echo "STGCN++ Training: 4-class Single Split (Bone)"
...
WORK_DIR="work_dirs/stgcnpp/single/4class_conf04_b"
EPOCHS=24
LR=0.01
