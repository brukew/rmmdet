#!/bin/bash
#SBATCH --job-name=stgcnpp_5cls_cv_b
#SBATCH --partition=pi_satra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/5class_cv_b_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/5class_cv_b_%j.err

echo "=========================================="
echo "STGCN++ Training: 5-class 3-Fold CV (Bone)"
...
BASE_WORK_DIR="work_dirs/stgcnpp/cv/5class_conf04_b"
EPOCHS=24
LR=0.01
