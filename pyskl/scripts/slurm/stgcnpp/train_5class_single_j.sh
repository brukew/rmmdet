#!/bin/bash
#SBATCH --job-name=stgcnpp_5cls_j
#SBATCH --partition=mit_preemptable
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=06:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/5class_single_j_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/stgcnpp/5class_single_j_%j.err

echo "=========================================="
echo "STGCN++ Training: 5-class Single Split (Joint)"
...
WORK_DIR="work_dirs/stgcnpp/single/5class_conf04_j"
EPOCHS=24
LR=0.01
