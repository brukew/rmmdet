...
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/4class_cv_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/4class_cv_%j.err
