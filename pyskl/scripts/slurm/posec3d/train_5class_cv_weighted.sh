#!/bin/bash
#SBATCH --job-name=posec3d_5cls_cv_w
#SBATCH --partition=pi_satra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/5class_cv_weighted_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/5class_cv_weighted_%j.err

echo "=========================================="
echo "PoseC3D Training: 5-class CV WITH CLASS WEIGHTING"
...
BASE_WORK_DIR="work_dirs/posec3d/cv/5class_conf04_weighted_sqrt"
EPOCHS=12
LR=0.00125
NUM_CLASSES=5
