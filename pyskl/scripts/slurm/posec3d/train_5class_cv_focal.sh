#!/bin/bash
#SBATCH --job-name=posec3d_5cls_cv_focal
#SBATCH --partition=mit_preemptable
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/5class_cv_focal_%j.out
#SBATCH --error=/orcd/data/satra/001/users/brukew/pyskl_logs/posec3d/5class_cv_focal_%j.err

echo "=========================================="
echo "PoseC3D Training: 5-class CV WITH FOCAL LOSS + EARLY STOPPING"
...
BASE_WORK_DIR="work_dirs/posec3d/cv/5class_conf04_focal"
