...
Usage:
    python tools/train_weighted.py configs/stgcn++/stgcnpp_sails_ntu60p/jm_tal_5class_focal.py \
        --ann-file data/sails/tal/cv_4class/5class_windows_conf04/fold0.pkl \
        --bg-subsample 0.2 \
        --work-dir work_dirs/stgcnpp/tal/cv_4class_5class_focal/jm/fold0 \
...
work_dir = './work_dirs/stgcnpp/tal/cv_4class_5class_focal/jm'
