...
Usage:
    ...
    python tools/train.py configs/stgcn++/stgcnpp_sails_ntu60p/j.py --launcher none --validate

    # Testing
    python tools/test.py configs/stgcn++/stgcnpp_sails_ntu60p/j.py CHECKPOINT --launcher none --eval top_k_accuracy mean_class_accuracy
"""
...
# NTU60 uses lr=0.1 for batch_size=16*8=128
# We use batch_size=16*1=16, so scale down: 0.1 * (16/128) = 0.0125
# Further reduce for finetuning stability
...
# Output directory
work_dir = './work_dirs/stgcn++/stgcnpp_sails_ntu60p/j'
