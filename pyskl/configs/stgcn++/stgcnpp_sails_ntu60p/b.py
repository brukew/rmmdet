...
Bone modality (b) - uses vectors between connected joints (position-invariant).
...
Usage:
    ...
    python tools/train.py configs/stgcn++/stgcnpp_sails_ntu60p/b.py --launcher none --validate

    # Testing
    python tools/test.py configs/stgcn++/stgcnpp_sails_ntu60p/b.py CHECKPOINT --launcher none --eval top_k_accuracy mean_class_accuracy
"""
...
# Data pipelines - BONE modality
train_pipeline = [
    dict(type='PreNormalize2D'),  # Normalize 2D keypoints to [-1, 1]
    dict(type='GenSkeFeat', dataset='coco', feats=['b']),  # Bone features
...
# Output directory
work_dir = './work_dirs/stgcn++/stgcnpp_sails_ntu60p/b'

# ============================================================================
# CRITICAL: Pretrained weights from NTU60 HRNet (bone modality)
# ============================================================================
load_from = 'checkpoints/stgcnpp/ntu60_hrnet_b.pth'
