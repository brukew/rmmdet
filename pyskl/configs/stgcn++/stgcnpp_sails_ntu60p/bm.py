...
Bone Motion modality (bm) - temporal velocity of bone vectors.
...
Usage:
    ...
    python tools/train.py configs/stgcn++/stgcnpp_sails_ntu60p/bm.py --launcher none --validate

    # Testing
    python tools/test.py configs/stgcn++/stgcnpp_sails_ntu60p/bm.py CHECKPOINT --launcher none --eval top_k_accuracy mean_class_accuracy
"""
...
# Data pipelines - BONE MOTION modality
train_pipeline = [
    dict(type='PreNormalize2D'),  # Normalize 2D keypoints to [-1, 1]
    dict(type='GenSkeFeat', dataset='coco', feats=['bm']),  # Bone motion features
...
# Output directory
work_dir = './work_dirs/stgcn++/stgcnpp_sails_ntu60p/bm'

# ============================================================================
# CRITICAL: Pretrained weights from NTU60 HRNet (bone motion modality)
# ============================================================================
load_from = 'checkpoints/stgcnpp/ntu60_hrnet_bm.pth'
