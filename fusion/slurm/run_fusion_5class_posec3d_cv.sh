...
#SBATCH --gres=gpu:1
#SBATCH -t 1:00:00
#SBATCH -o slurm-logs/fusion_5class_posec3d_cv_%j.out
#SBATCH -e slurm-logs/fusion_5class_posec3d_cv_%j.err
...
POSEC3D_ROOT=${REPO_ROOT}/pyskl/work_dirs/posec3d/cv/5class_conf04_weighted

OUTPUT_DIR=${REPO_ROOT}/fusion/runs/5class_cv_posec3d_mlp
