...
#SBATCH -o slurm-logs/vjepa_cv_4class%j.out
#SBATCH -e slurm-logs/vjepa_cv_4class%j.err
...
# Paths
# ============================================================================
CSV_DIR=${CSV_DIR:-${REPO_ROOT}/dataprep/splits/cv_splits}
CLIPS_ROOT=${CLIPS_ROOT:-$CLASSIFICATION_CLIPS}
OUTPUT_ROOT=${OUTPUT_ROOT:-${REPO_ROOT}/v-jepa/runs/vjepa2_rmm_cv}
