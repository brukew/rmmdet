...
#SBATCH -o slurm-logs/vjepa_sweep_%A_%a.out
#SBATCH -e slurm-logs/vjepa_sweep_%A_%a.err
#SBATCH -a 0-7%4
...
OUTPUT_ROOT=${OUTPUT_ROOT:-${REPO_ROOT}/v-jepa/runs/vjepa2_rmm_type_cv_sweep}
